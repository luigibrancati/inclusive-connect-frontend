...
class AccessibilityControls extends StatelessWidget {
  ...
  void _showAccessibilityBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        minChildSize: 0.5,
        expand: false,
        builder: (context, scrollController) => Consumer2<ThemeService, TtsService>(
          builder: (context, themeService, ttsService, child) {
            return ListView(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.accessibilitySettingsTitle,
                  style: Theme.of(context).textTheme.headlineSmall,
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: 16),
                _buildSectionHeader(context, AppLocalizations.of(context)!.visibilitySettingsTitle),
                SwitchListTile(
                  title: Text(AppLocalizations.of(context)!.highContrastSettingTitle),
                  subtitle: Text(
                ...
                const Divider(),
                _buildSectionHeader(context, AppLocalizations.of(context)!.typographySettingsTitle),
                SwitchListTile(
                  title: Text(AppLocalizations.of(context)!.typographySettingsLabelTitle),
                  subtitle: Text(
                ...
                const Divider(),
                _buildSectionHeader(context, AppLocalizations.of(context)!.ttsSettingsTitle),
                ...
                Padding(
                  ...
                  child: Center(
                    child: InstaButton(
                      ...
                      child: Text(AppLocalizations.of(context)!.ttsSettingsTestButtonLabel),
                    ),
                  ),
                ),
                const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    return FloatingActionButton(
      ...
      onPressed: () => _showAccessibilityBottomSheet(context),
